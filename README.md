# Проект по автоматизации тестирования для сайта компании [СИНТЕКА](https://cynteka.ru/)

![cynteka](media/screen/cynteka.png "Главная страница")

<p> Синтека разработала систему автоматизации снабжения «Синтека.Комплектация». Первый запуск системы в&nbsp;работу произошел в декабре 2012 года и с тех пор Синтека постоянно работает над улучшением своей системы с непосредственными пользователями – прорабами, начальниками участков, технологами, руководителями проектов, снабженцами, бухгалтерами, директорами компаний. Благодаря такой обратной связи, Синтека создала по-настоящему мощный и гибкий инструмент для строительных и производственных компаний.
</p>
...
Auto:
- ✓ Проверка наличия вакансии в разделе "Вакансии"
- ✓ Проверка заголовка на соответствующем языке
- ✓ Проверка кнопки меню страницы для русского языка
- ✓ Проверка первого заголовка в "Разделе о СМИ"
- ✓ Проверка наличия электронной почты в Разделе "Контакты"
...
gradle clean title_tests  запуск тестов, которые проверяют заголовки
gradle clean smoke_tests запуск важных тестов
```
____
<a id="jenkins"></a>
## <img width="4%" style="vertical-align:middle" title="Jenkins" src="media/logo/Jenkins.svg"> </a> Сборка в <a target="_blank" href="https://jenkins.autotests.cloud/job/free-test-17/"> Jenkins </a>
...
____
<a id="allureReport"></a>
## <img width="4%" style="vertical-align:middle" title="Allure Report" src="media/logo/Allure_Report.svg"> </a> Пример <a target="_blank" href="https://jenkins.autotests.cloud/job/free-test-17/4/allure/"> Allure-отчета </a>
...
____
<a id="jira"></a>
## <img width="4%" style="vertical-align:middle" title="Jira" src="media/logo/Jira.svg"> </a> Интеграция с <a target="_blank" href="https://jira.autotests.cloud/browse/HOMEWORK-1092"> Jira </a>
